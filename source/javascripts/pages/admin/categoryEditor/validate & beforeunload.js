...
$(function(){
  if (document.body.contains(document.querySelector('#categoryEditor'))) {
    (function () {
      ...
      const submitButton = document.querySelector('#categoryEditor button.btn-primary');
      // validate
      // 1. 防止表單在驗證之前傳送
      ...
      function handleOverlapping(input, submit) {
        if (submit) {
          $('#categoryEditor button.btn-primary').html('<div class="sk-chase-large"><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div><div class="sk-chase-dot"></div></div>');
        }
        ...
        $.ajax({
          ...
          if (res === '已有重複的網址') {
            ...
            submitting = false;
            if (submit) {
              $('#categoryEditor button.btn-primary').html('發佈');
